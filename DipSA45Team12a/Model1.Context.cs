...
namespace DipSA45Team12a
{
    ...
    public partial class DipSA45Team12aLibEntities : DbContext
    {
        public DipSA45Team12aLibEntities()
            : base("name=DipSA45Team12aLibEntities")
        {
        }
        ...
        public virtual ObjectResult<printReceipt_Result> printReceipt(Nullable<int> transID)
        {
            var transIDParameter = transID.HasValue ?
                new ObjectParameter("transID", transID) :
                new ObjectParameter("transID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<printReceipt_Result>("printReceipt", transIDParameter);
        }
    }
}
